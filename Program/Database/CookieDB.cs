...
namespace Server
{
    internal static class CookieDB
    {
        ...
        private static readonly System.Timers.Timer _timer = new(LOGIN_TIME * 0.2d * 1000d);
	...
	PRIMARY KEY(""LoginUsername"")
        ...
        internal static String AddUser(String loginUsername, IPAddress clientIP)
        {
            ...
            Span<Byte> token = stackalloc Byte[128];
        ...
        internal static TokenState ValidateToken(String base64Token, IPAddress clientIP, out String loginUsername)
        {
            ...
            lock (_databaseLock)
            {
                ...
                command.Parameters.Add("@token", DbType.String).Value = base64Token;
                ...
                {
                    Log.FastLog("Authenticating clients token had an IP mismatch -> removing token from database", LogSeverity.Alert, "CookieDB");
