...
//                try
//                {
//                    if (!Directory.Exists(Program.AssemblyPath + $"files\\{targetUser.LoginUsername}"))
//                    {
//                        Directory.CreateDirectory(Program.AssemblyPath + $"files\\{targetUser.LoginUsername}");
//                    }
...
//                try
//                {
//                    fileStream = new("\\\\?\\" + Program.AssemblyPath + $"files\\{targetUser.LoginUsername}\\" + filename, FileMode.Create, FileAccess.Write, FileShare.None, 65535, false);
//                }
...
//                {
//                    if (driveInfo[i].Name[0] == Program.AssemblyPath![0])
//                    {
