...
//                if (invokingUser.IsAdministrator) fileContent = fileContent.Replace("<!-- #THREADPOOL#ANCHOR# -->", $"Thread pool Threads: {ThreadPoolX.Available - ThreadPoolX.Count}/{ThreadPoolX.Count}");
