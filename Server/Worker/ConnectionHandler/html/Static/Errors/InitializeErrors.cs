    ...
    internal static partial class HTML
    {
        internal static partial class HTML_STATIC
        {
            private static void InitializeErrors()
            {
                ...
                headerBuffer = CraftHeader(ResponseType.HTTP_429, ContentType.HTML, bodyBuffer.LongLength, false, null).Item1;
                ...
                headerBuffer = CraftHeader(ResponseType.HTTP_431, ContentType.HTML, bodyBuffer.LongLength, false, null).Item1;
                ...
                headerBuffer = CraftHeader(ResponseType.HTTP_404, ContentType.HTML, bodyBuffer.LongLength, false, null).Item1;
                ...
                headerBuffer = CraftHeader(ResponseType.HTTP_400, ContentType.HTML, bodyBuffer.LongLength, false, null).Item1;
